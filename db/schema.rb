...
ActiveRecord::Schema.define(version: 20160528121731) do

  create_table "alunos", force: :cascade do |t|
    t.string   "mat",         limit: 255,                default: "MA2001", null: false
  ...
  add_index "alunos_disciplinas", ["aluno_id", "disciplina_id"], name: "index_alunos_disciplinas_on_aluno_id_and_disciplina_id", using: :btree
  add_index "alunos_disciplinas", ["disciplina_id", "aluno_id"], name: "index_alunos_disciplinas_on_disciplina_id_and_aluno_id", using: :btree
